...
if __name__ == '__main__':
    ...
    splitting_seed = 100  # TODO: use as input
    ...
    start_step_of_polynomial_decay = 500  # TODO
    end_step_of_polynomial_decay = 2500
    big_to_small_joint_lr_step = 3500
    lr_switch = 4750
    n_total = 7500

    # start_step_of_polynomial_decay = 1
    # end_step_of_polynomial_decay = 3
    # big_to_small_joint_lr_step = 5
    # lr_switch = 7
    # n_total = 10
    ...
    if track_wandb:
        wandb.init(
            project="ThesisRunsInterpolation",
            # project="Debug_stuff",
            entity="wenkph",
            config=run_dict,
    ...
    model.train(num_steps_smoother_pretraining=0,
                num_steps_dynamics_pretraining=5000,
                number_of_steps=0)
    model.store_parameters(name="DPre_")
    # model.plot_first_few_trajectories_at_all_times(n_trajectories_to_plot=10, plot_equidistantly=True,
    #                                                name_prefix='DPre_')
    # model.calculate_metrics_and_push_to_wandb_on_train('DPre_', ignore_third_dimension=True)
    # model.calculate_metrics_and_push_to_wandb_on_test('DPre_', ignore_third_dimension=True)
    # model.calculate_metrics_and_push_to_wandb_on_train('SPre', ignore_third_dimension=True)
    # model.calculate_metrics_and_push_to_wandb_on_test('SPre_', ignore_third_dimension=True)
    # model.store_parameters(name="DPre")

    model.train(num_steps_smoother_pretraining=0,
                num_steps_dynamics_pretraining=0,
                number_of_steps=n_total)
